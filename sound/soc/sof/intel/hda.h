...
void hda_dsp_free_irq(struct snd_sof_dev *sdev);
int hda_dsp_request_irq(struct snd_sof_dev *sdev);
...
void hda_codec_jack_check(struct snd_sof_dev *sdev, u32 status);
